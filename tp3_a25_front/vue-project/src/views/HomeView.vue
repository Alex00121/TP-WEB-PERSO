  ...
  <div class="page">
    <div class="main-container">
      ...
      <section>
        ...
        <p v-if="!booksStore.loading && booksStore.books.length === 0" class="center"> Aucun livre trouvé.</p>
        <div class="grid-wrapper">
          <div class="grid">

            <div v-for="book in booksStore.books" :key="book._id" class="card">
              <img :src="book.couverture || '/book-placeholder.png'" class="book-image" />
              <h3>{{ book.titre }}</h3>

              <span class="badge-rupture" :style="{ visibility: book.quantite === 0 ? 'visible' : 'hidden' }">
                Rupture de stock
              </span>
              ...
              <button :disabled="book.quantite === 0" @click="addToCart(book._id)">
                Ajouter au panier
              </button>
        ...
        <div v-if="booksStore.pagination" class="pagination">
          ...
          <button :disabled="booksStore.pagination.page >=
